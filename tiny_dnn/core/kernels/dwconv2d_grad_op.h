...
class DWConv2dGradOp : public core::OpKernel {
 public:
  explicit DWConv2dGradOp(const core::OpKernelConstruction &context)
  ...
  void compute(core::OpKernelContext &context) override {
    ...
    if (engine == core::backend_t::internal) {
      kernels::dwconv2d_op_internal(prev_out, W[0], dW, db, curr_delta,
